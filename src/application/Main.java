...
public class Main extends Application implements InterListe {
	...
	static Group panel;
	@FXML  private static Label lapelTime;
	@FXML  private static Button btn_valider;
	@FXML  private static Button btn_debut;
	@FXML static Label lapel_score;
	static ArrayList<ToggleGroup> listeRadioButtonGroup;
	@FXML private static Stage pStage;
	@FXML private static Timeline timeline;
	@FXML private static TextField txt_nom;
	@FXML private static TextField txt_prenom;
	@FXML private static TextField txt_age;
	@FXML private static Label label_nom;
	@FXML private static Label label_prenom;
	@FXML private static Label label_age;
	static MP3Player music;
	@FXML private static AnchorPane Anchor;
	...
	static ImageView live3 = new ImageView(new Image("file:points.png")); 
